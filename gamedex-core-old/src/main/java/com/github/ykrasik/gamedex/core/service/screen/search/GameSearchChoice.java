...
public class GameSearchChoice {
    ...
    @NonNull private final Opt<ProviderSearchResult> searchResult;
    ...
    public static GameSearchChoice select(ProviderSearchResult providerSearchResult) {
        return new GameSearchChoice(GameSearchChoiceType.SELECT_RESULT, Opt.some(providerSearchResult), Opt.none());
    }

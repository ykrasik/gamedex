 ...
 * Time: 12:05
 */
interface ImportDatabasePresenter {
    fun importDatabase()
}

interface ViewCanImportDatabase {
    fun selectDatabaseImportFile(initialDirectory: File?): File?
    fun confirmImportDatabase(): Boolean
}

interface ImportDatabasePresenterFactory : PresenterFactory<ViewCanImportDatabase, ImportDatabasePresenter>
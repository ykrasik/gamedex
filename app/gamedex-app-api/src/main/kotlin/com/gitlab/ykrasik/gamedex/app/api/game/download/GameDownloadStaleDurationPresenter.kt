 ...
 * Time: 09:43
 */
interface GameDownloadStaleDurationPresenter{
    fun onStalePeriodTextChanged(stalePeriodText: String)
}

interface ViewWithDownloadStaleDuration {
    var stalePeriodText: String
    var stalePeriodValidationError: String?
}

interface GameDownloadStaleDurationPresenterFactory : PresenterFactory<ViewWithDownloadStaleDuration, GameDownloadStaleDurationPresenter>
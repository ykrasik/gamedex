 ...
 * Time: 08:08
 */
interface EditGameViewPresenter {
    fun onShown(game: Game, initialTab: GameDataType)
...
interface EditGameView {
    ...
    fun close(choice: EditGameDetailsChoice)
}
...
interface EditGameViewPresenterFactory : PresenterFactory<EditGameView, EditGameViewPresenter>
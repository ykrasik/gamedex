...
public class GameInfo2 {
    ...
    // TODO: Consider adding the platform here.

    public static GameInfo2 merge(MetacriticGameInfo metacriticGameInfo, GiantBombGameInfo giantBombGameInfo) {
        ...
        return new GameInfo2(
            ...
            Optional.of(giantBombGameInfo.getDetailUrl()),
    ...
    public static GameInfo2 from(MetacriticGameInfo metacriticGameInfo) {

...
import static com.github.ykrasik.indexter.games.info.metacritic.MetacriticApi.*;
...
public class MetacriticGameInfoService implements GameInfoService {
    ...
    public GameInfoProvider getProvider() {
        return GameInfoProvider.METACRITIC;
    }

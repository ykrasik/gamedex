...
import com.github.ykrasik.gamedex.ui.dialog.SearchableCheckListViewDialog;
import com.github.ykrasik.gamedex.ui.element.gridview.GameInfoCell;
...
public class GameController {
    ...
    private void initGameSearch() {
        ...
        clearGameSearch.setGraphic(new ImageView(UIResources.getSmallX()));

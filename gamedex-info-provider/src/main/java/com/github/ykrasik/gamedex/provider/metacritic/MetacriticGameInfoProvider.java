...
//public class MetacriticGameInfoProvider implements DataProvider {
...
//    }
//
//    private ImmutableList<String> getGenre(JsonNode node) {
//        return Lists.immutable.ofAll(getString(node, GENRE).toList());
//    }
//

...
//    @Bean
//    public DataProvider metacriticGameInfoProvider(@Qualifier("metacriticInfo") GameInfoProviderInfo info,
...
//    @Bean
//    public DataProvider giantBombGameInfoProvider(@Qualifier("giantBombInfo") GameInfoProviderInfo info,

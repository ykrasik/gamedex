...
class GameGenreDaoTest : DaoTest() {
    ...
    init {
        "GameGenreDao" should {
            "link single genre to game and be able to retrieve that link" {
            ...
            "link multiple genres to multiple games and be able to retrieve those links" {
    ...
    private fun givenGenresAreLinkedToGame(game: Game, vararg genres: Genre) {
        dao.link(game.id, genres.toList())
    }
}
...
class DiscoverGamesWithoutProvidersPresenter @Inject constructor(
    ...
    override fun present(view: ViewCanDiscoverGamesWithoutProviders) = object : ViewSession() {
        init {
        ...
        private suspend fun discoverGamesWithoutProviders() {
            taskService.execute(gameDiscoveryService.rediscoverGamesWithMissingProviders())
        }
    }
}
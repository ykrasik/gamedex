...
import com.gitlab.ykrasik.gamedex.app.api.game.download.RedownloadAllStaleGamesPresenter
 ...
 */
@Singleton
class RedownloadAllStaleGamesPresenterFactoryImpl @Inject constructor(
    private val gameDownloadService: GameDownloadService,
    private val taskRunner: TaskRunner
) : RedownloadAllStaleGamesPresenterFactory {
    override fun present(view: ViewCanRedownloadAllStaleGames): RedownloadAllStaleGamesPresenter = object : RedownloadAllStaleGamesPresenter {
        override fun redownloadAllStaleGames() = launchOnUi {

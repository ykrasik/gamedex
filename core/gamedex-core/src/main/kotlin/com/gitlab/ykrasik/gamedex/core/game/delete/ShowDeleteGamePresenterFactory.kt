 ...
 */
@Singleton
class ShowDeleteGamePresenterFactory @Inject constructor(private val viewManager: ViewManager) : PresenterFactory<ViewCanDeleteGame> {
    override fun present(view: ViewCanDeleteGame) = object : Presenter() {
        init {

 ...
 */
@Singleton
class ShowAddLibraryPresenterFactory @Inject constructor(private val viewManager: ViewManager) : PresenterFactory<ViewCanAddLibrary> {
    override fun present(view: ViewCanAddLibrary) = object : Presenter() {
        init {

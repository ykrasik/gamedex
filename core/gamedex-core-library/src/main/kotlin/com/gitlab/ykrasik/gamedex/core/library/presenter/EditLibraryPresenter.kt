...
class EditLibraryPresenter @Inject constructor(
    ...
    override fun present(view: EditLibraryView) = object : ViewSession() {
        ...
        private fun onTypeChanged(type: LibraryType) {
            ...
            view.shouldShowPath *= Try {
                check(type != LibraryType.Physical) { "Physical libraries don't have a path!" }
            }
            validate()
        }
        ...
        private fun validatePath() {
            view.pathIsValid *= view.shouldShowPath.value.not.or(Try {
        ...
        private suspend fun onAccept() {
            ...
            val libraryData = LibraryData(
                ...
                path = if (view.type.value == LibraryType.Physical) view.name.value.file else view.path.value.file,

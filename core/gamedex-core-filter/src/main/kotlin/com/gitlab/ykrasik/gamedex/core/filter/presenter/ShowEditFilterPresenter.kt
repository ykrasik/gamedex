...
import com.gitlab.ykrasik.gamedex.app.api.filter.ViewCanEditFilter
 ...
 */
@Singleton
class ShowEditFilterPresenter @Inject constructor(
    private val viewManager: ViewManager,
    eventBus: EventBus
) : Presenter<ViewCanEditFilter> {
    init {
        eventBus.onHideViewRequested<EditFilterView> { viewManager.hide(it) }
    }

    override fun present(view: ViewCanEditFilter) = object : ViewSession() {
        init {
            view.editFilterActions.forEach {
